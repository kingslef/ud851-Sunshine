...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int WEATHER_LOADER = 33;
    private static final String WEATHER_LOCATION_EXTRA = "weather";
     ...
     */
    private void loadWeatherData(boolean forceLoad) {
        showWeatherDataView();

        String location = SunshinePreferences.getPreferredWeatherLocation(this);

        Bundle bundle = new Bundle();
        bundle.putString(WEATHER_LOCATION_EXTRA, location);
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            protected void onStartLoading() {
                ...
                if (mWeatherData == null) {
                    Log.i("WeatherLoader", "Loading " + args.get(WEATHER_LOCATION_EXTRA));

                    mLoadingIndicator.setVisibility(View.VISIBLE);

                    forceLoad();
                } else {
                    Log.i("WeatherLoader", "Delivering cached " + args.get(WEATHER_LOCATION_EXTRA));
